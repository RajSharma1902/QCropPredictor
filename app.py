...
def load_models():
    ...
    return vqc_model, vqc_scaler, vqc_class_names, qnn_model, qnn_scaler, qnn_label_encoder

vqc_model, vqc_scaler, vqc_class_names, qnn_model, qnn_scaler, qnn_label_encoder = load_models()
